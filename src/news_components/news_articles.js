...
let news_articles = [
  ...
  },
  {
      ...
      "date": "June 8 2026",
      "content": "At the NSF site visit, there was a poster and demo competition for the graduate researchers, in which there were 16 entries. Three judges viewed these entries and discussed with the researchers. They scored the entries on technical content (50%), lightning talk (25%), and presentation + Q&nbspA (25%). Thanks to the judges, Dr. Mark Tschopp, Prof. T. N. Vijaykumar, and Prof. Ashraf Alam. CHORUS PI, Yin Li from the University of Wisconsin organized the competition. The winners came out to be:  \n
